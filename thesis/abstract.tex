...
\chapter*{РЕФЕРАТ}
Дипломная работа, 46 с., 8 рис., 13 источников.
...
\textbf{Предмет исследования}: алгоритмические и архитектурные решения обеспечения отказоустойчивости, строгой согласованности данных и динамической реконфигурации кластера на базе протокола Raft.
...
\chapter*{РЭФЕРАТ}
Дыпломная праца, 46 с., 8 мал., 13 крынiц.
...
\textbf{Прадмет даследавання}: алгарытмічныя і архітэктурныя рашэнні забеспячэння адмоваўстойлівасці, строгай узгодненасці дадзеных і дынамічнай рэканфігурацыі кластара на базе пратакола Raft.
...
\chapter*{ABSTRACT}
Diploma thesis, 46 p., 8 fig., 13 sources.
...
\textbf{Subject of research}: algorithmic and architectural solutions for ensuring fault tolerance, strict data consistency, and dynamic cluster reconfiguration based on the Raft protocol.
